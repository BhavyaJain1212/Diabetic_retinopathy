...
class BalancedSplitDataset(Dataset):
    def __init__(
        ...
        undersample_threshold=715, oversample_target_train=500, random_seed=42):
        super().__init__()
        ...
        # Undersample 'Moderate' and 'No_DR'
        ...
        # Oversample undersized classes in TRAIN split to 500 each
        ...
        # Print class-wise counts for each split
...
learning_rate = 1e-4
num_epochs = 30   # increased epochs for longer training
patience = 7      # increased early stopping patience


train_transforms = transforms.Compose([
    transforms.RandomResizedCrop(input_size, scale=(0.8, 1.0)),  # stronger augmentation
...
# Model: ResNeXt50_32x4d with dropout before fc
...
torch.save(model.state_dict(), 'resnext50_balanced_aug_dropout.pth')
