...
class BalancedSplitDataset(Dataset):
    def __init__(
        ...
        # Undersample 'No_DR' specifically to 1000, keep 'Moderate' untouched
        cls_name = 'No_DR'
        ...
        # Oversample undersampled classes in TRAIN split to 750 each
...
# Unfreeze layer3, layer4, and classifier head to fine-tune
for name, child in model.named_children():
    if name in ['layer3', 'layer4', 'fc']:
        for param in child.parameters():
            param.requires_grad = True

# Optimizer updates only params requiring gradient
...
torch.save(model.state_dict(), 'resnext50_balanced_undersampleNoDR_oversample750.pth')
