...
# ----------------------------- MODEL ---------------------------------
model = EfficientNetBN("efficientnet-b0", pretrained=True, spatial_dims=2, in_channels=3, num_classes=num_classes)
model = model.to(device)

# ---- Selective Freezing (for MONAI EfficientNetBN) ----
# Freeze early layers: conv_stem + first 4 blocks
...
# Unfreeze later layers and classifier
for block in model._blocks[4:]:
    for param in block.parameters():
