...
class BalancedSplitDataset(Dataset):
    def __init__(
        ...
        # Undersample 'No_DR' to 1000 images only
        cls_name = 'No_DR'
        ...
        # Combine indices after undersampling
        combined_indices = []
        ...
        # Oversample underrepresented classes to 750 in training set
        ...
        # Print class-wise counts for debugging
...
# Model setup with dropout on classifier
...
# Freeze layers except last two blocks and classifier
...
# Setup GradCAM for last conv layer
